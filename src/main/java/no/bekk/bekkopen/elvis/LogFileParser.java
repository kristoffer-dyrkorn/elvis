...
public class LogFileParser {
	...
	private int linesPerBatch = 10000;
	private ESIntegration esIntegration = null;

	static final Logger log = Logger.getLogger(LogFileParser.class);

	public LogFileParser(ESIntegration integration) {
		esIntegration = integration;
	}
